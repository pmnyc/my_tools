...
class saletruliaSpider(CrawlSpider):
    ...
    start_urls = [
        'http://www.trulia.com/property/3039239330-40-Huntington-Ave-Worcester-MA-01606' #change!!!!!
    ]
    ...
    def parse_item_sales(self, response):
        ...
        try:
            selector_list = response.css('ul.listInline.pdpFeatureList')
            selector = selector_list[0] # since we are only dealing with one property at a webpage
