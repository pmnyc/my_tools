...
class saletruliaSpider(CrawlSpider):
    name = "Trulia_Home_Sale"
    allowed_domains = ["www.trulia.com",'trulia.com']
    start_urls = [
        'http://www.trulia.com/homes/Massachusetts/Worcester/sold/1779200-61-Edgeworth-St-Worcester-MA-01605' #change!!!!!
    ]
    ...
    rules =[
        Rule(LinkExtractor(
                ...
                allow=('/homes/Massachusetts/Worcester/sold/1779200\S*'), #change!!!!!
