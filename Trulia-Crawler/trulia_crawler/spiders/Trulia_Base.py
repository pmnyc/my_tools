...
base crawler for the trulia.com
    ...
    We may use the following to check the validity of the regex string for matches used in the rules
        later on
    >>> import re
...
class saletruliaSpider(CrawlSpider):
    name = "Trulia_Base"
    allowed_domains = ["www.trulia.com",'trulia.com']
    start_urls = [
        'http://www.trulia.com/property/3039239330-40-Huntington-Ave-Worcester-MA-01606'
        # This is just a temporary link for testing the code #
    ]
    ...
    rules =[
        Rule(LinkExtractor(
                # the string in allow= is also of the regex format
                allow=('/property/3039239330\S*'),
                # This is just a temporary link for testing the code #
                deny=['subsection\.php']), # this is to define the denied links matching this pattern
                callback='parse_item',
                follow=True)
    ]
